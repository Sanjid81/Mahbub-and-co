    ...
    Container::make('theme_options', __('Footer Options'))
        ...
        ->add_fields(array(
            ...
            Field::make('text', 'footer_copyright', 'Copyright Text')
                ->set_help_text('Use {year} for current year, e.g. © {year} Mahbub & Co. All rights reserved'),
...
add_action('carbon_fields_register_fields', function () {
    ...
    ->add_fields( array(
        ...
        Field::make( 'text', 'user_email', 'Email Address' )->set_attribute('placeholder', 'author@example.com'),
