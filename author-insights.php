...
if ($author_cpt_query->have_posts()) {
    ...
    $author_email = carbon_get_post_meta($author_post_id, 'user_email');
    ...
    if ($author) {
        ...
        $author_email = carbon_get_user_meta($author->ID, 'user_email');
