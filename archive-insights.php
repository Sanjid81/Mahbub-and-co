...
<div class="insights-archive-section">
    ...
    $terms = get_terms([
        ...
        'hide_empty' => false,           // show empty categories too (change to true if you want to hide them)
        'orderby' => 'name',
        'order' => 'ASC',
    ]);
                ...
                <div class="insights-tab-contents">
                    ...
                    foreach ($categories as $slug => $name):
                        ...
                        $posts_query = new WP_Query([
                            'post_type' => 'insights',
                            'posts_per_page' => -1,                 // change to 9, 12 etc if you want limit + pagination later
                            'orderby' => 'date',
                            'order' => 'DESC',
                            'tax_query' => [
                                [
